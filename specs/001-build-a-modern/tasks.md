...
- [ ] T071 [P] [US2] Create Course model in backend/src/models/course.py (id, instructor_id, title, description, category, visibility, enrollment_capacity, thumbnail_url, is_featured, timestamps)
- [ ] T072 [P] [US2] Create Module model in backend/src/models/module.py (id, course_id, title, description, order_index, timestamps)
- [ ] T073 [P] [US2] Create ContentItem model in backend/src/models/content_item.py (id, course_id, module_id, title, description, content_type, file_url, file_size, mime_type, text_content, duration_seconds, order_index, is_required, timestamps)
- [ ] T074 [US2] Create Alembic migration for Course, Module, ContentItem tables with foreign keys and indexes
- [ ] T075 [P] [US2] Create Course Pydantic schemas in backend/src/schemas/course.py (CourseCreate, CourseUpdate, CourseResponse, CourseListResponse)
- [ ] T076 [P] [US2] Create Module Pydantic schemas in backend/src/schemas/module.py (ModuleCreate, ModuleResponse)
- [ ] T077 [P] [US2] Create ContentItem Pydantic schemas in backend/src/schemas/content_item.py (ContentItemCreate, ContentItemResponse)
- [ ] T078 [US2] Implement course service in backend/src/services/course_service.py (create_course, update_course, delete_course, get_course_by_id, list_courses with pagination)
- [ ] T079 [US2] Implement content service in backend/src/services/content_service.py (upload_content, get_content_by_id, delete_content, generate_signed_url)
- [ ] T080 [US2] Implement POST /api/v1/courses endpoint in backend/src/api/courses.py (instructor/admin only)
- [ ] T081 [US2] Implement GET /api/v1/courses endpoint in backend/src/api/courses.py (list published courses with pagination, category filter)
- [ ] T082 [US2] Implement GET /api/v1/courses/{course_id} endpoint in backend/src/api/courses.py (full course details with modules and content)
- [ ] T083 [US2] Implement PUT /api/v1/courses/{course_id} endpoint in backend/src/api/courses.py (course owner or admin only)
- [ ] T084 [US2] Implement DELETE /api/v1/courses/{course_id} endpoint in backend/src/api/courses.py (course owner or admin only)
- [ ] T085 [US2] Implement POST /api/v1/content endpoint in backend/src/api/content.py (multipart/form-data, file upload handling, instructor/admin only)
- [ ] T086 [US2] Implement GET /api/v1/content/{content_id} endpoint in backend/src/api/content.py (enrolled student or course instructor)
- [ ] T087 [US2] Add file validation in backend/src/services/content_service.py (2GB max, whitelist: mp4/mov for video, pdf/docx for documents)
- [ ] T088 [US2] Add course ownership check middleware in backend/src/core/dependencies.py (verify user owns course)

### Frontend Implementation for User Story 2

- [ ] T089 [P] [US2] Create courses API client in frontend/src/api/courses.ts (createCourse, getCourses, getCourse, updateCourse, deleteCourse)
- [ ] T090 [P] [US2] Create content API client in frontend/src/api/content.ts (uploadContent, getContent)
- [ ] T091 [P] [US2] Create Course TypeScript types in frontend/src/types/course.ts (Course, CourseVisibility, Category, Module, ContentItem, ContentType)
- [ ] T092 [US2] Create CourseForm component in frontend/src/components/courses/CourseForm.tsx (title, description, category, visibility inputs with validation)
- [ ] T093 [US2] Create ContentUpload component in frontend/src/components/courses/ContentUpload.tsx (file drag-drop, progress bar, type selector)
- [ ] T094 [US2] Create ModuleList component in frontend/src/components/courses/ModuleList.tsx (display modules with content items, reorder functionality)
- [ ] T095 [US2] Create CourseCard component in frontend/src/components/courses/CourseCard.tsx (thumbnail, title, instructor, enrollment count)
- [ ] T096 [US2] Create CreateCoursePage in frontend/src/pages/instructor/CreateCoursePage.tsx (use CourseForm, redirect after creation)
- [ ] T097 [US2] Create EditCoursePage in frontend/src/pages/instructor/EditCoursePage.tsx (load existing course, use CourseForm, save changes)
- [ ] T098 [US2] Create CourseContentManager page in frontend/src/pages/instructor/CourseContentManager.tsx (upload content, organize modules, reorder items)
- [ ] T099 [US2] Create CourseCatalog page in frontend/src/pages/courses/CourseCatalog.tsx (list published courses, pagination, category filter)
- [ ] T100 [US2] Create CourseDetailsPage in frontend/src/pages/courses/CourseDetailsPage.tsx (display course info, modules, content list, enroll button)
- [ ] T101 [US2] Add course management routes to InstructorDashboard (My Courses, Create Course)
